      ...
      <div style={styles.container} className="width">
        <div>
          ...
          <div>
            ...
            <h3 id="1-correction" className="has-text-weight-bold is-size-5">
              1. Correction
            </h3>
            ...
            <h3 id="2-warning" className="has-text-weight-bold is-size-5">
              2. Warning
            </h3>
            ...
            <h3 id="4-permanent-ban" className="has-text-weight-bold is-size-5">
              4. Permanent Ban
            </h3>
